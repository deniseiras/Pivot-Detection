# https://github.com/iboates/ndvi/tree/master/ndvi
...
# TODO criar as bandas de infra e near dentro do raster ndvi ?
...
def ndvi(in_nir_band, in_colour_band, in_rows, in_cols, in_geotransform, out_tiff, data_type=gdal.GDT_Float32):
    ...
    print("NDVI min {}, max {}, mean {}".format(np.nanmin(result), np.nanmax(result), np.nanmean(result)))
